...
const CertificationsSection: React.FC = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      issuer: "Oracle",
      date: "2024",
      description: "Expertise in Large Language Models (LLMs) and Generative AI services on Oracle Cloud Infrastructure.",
      skills: ["Generative AI", "LLMs", "OCI", "AI Services"],
      gradient: "from-red-400 to-orange-500",
      pdf: "/certificates/oracle_generative_ai.pdf"
    },
    {
      title: "Aviatrix Certified Engineer (ACE)",
      issuer: "Aviatrix",
      date: "2024",
      description: "Certification in multi-cloud networking, architecture, and security across AWS, Azure, Google Cloud, and OCI.",
      skills: ["Multi-Cloud Networking", "Cloud Security", "Network Architecture"],
      gradient: "from-orange-400 to-pink-500",
      pdf: "/certificates/aviatrix_ace.pdf"
    },
    {
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {certifications.map((cert, index) => (
            ...
            >
              <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20 transform-gpu h-full flex flex-col">
                ...
                <motion.div
                  ...
                  className={`inline-flex p-3 bg-gradient-to-r ${cert.gradient} bg-opacity-20 rounded-xl mb-4 relative z-10 w-fit`}
                >
